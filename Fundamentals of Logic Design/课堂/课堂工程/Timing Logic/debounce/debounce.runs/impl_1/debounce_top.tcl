...
set rc [catch {
  ...
  add_files -quiet D:/debounce/debounce.runs/synth_1/debounce_top.dcp
  read_xdc D:/debounce/debounce.srcs/constrs_1/new/debounce.xdc
  link_design -top debounce_top -part xc7a100tcsg324-1
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file debounce_top_timing_summary_routed.rpt -warn_on_violation  -rpx debounce_top_timing_summary_routed.rpx"
