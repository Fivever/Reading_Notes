...
HD_PWD='C:/Users/Charl/Desktop/Final/Final.runs/gray_picture_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gray_picture_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gray_picture_ram.tcl
