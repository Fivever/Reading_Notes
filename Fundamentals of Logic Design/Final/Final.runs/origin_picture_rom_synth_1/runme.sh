...
HD_PWD='C:/Users/Charl/Desktop/Final/Final.runs/origin_picture_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log origin_picture_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source origin_picture_rom.tcl
