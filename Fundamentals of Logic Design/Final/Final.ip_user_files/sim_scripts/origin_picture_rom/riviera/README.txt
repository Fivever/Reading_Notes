...
#
# Generated by export_simulation on Fri Jan 04 02:33:15 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './origin_picture_rom.sh' script.

./origin_picture_rom.sh -reset_run
...
./origin_picture_rom.sh -noclean_files

For more information on the script, please type './origin_picture_rom.sh -help'.
